        ...
        <div>
            ...
            <section className="questions">
                <div className='md:max-w-[75%] m-auto p-4'>
                    <Accordion title={<h2 className='font-bold'>What is a hernia?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>What are the symptoms of hernia?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'> How is a hernia diagnosed?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>What are the treatment options for a hernia?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>What is minimally invasive hernia surgery?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>How long is the recovery period after hernia surgery?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>Are there risks associated with hernia surgery?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'> Can a hernia come back after surgery?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>How can I prevent a hernia?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
                    ...
                    <Accordion title={<h2 className='font-bold'>How do I schedule a consultation with a hernia specialist?</h2>} answer={<div className='my-[2rem] text-[14px] flex flex-col gap-5'>
                        <p>
