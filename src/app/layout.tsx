...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
      <meta name="google-site-verification" content="Xg_f-kPWuWVCH8tNdSPToJJQ5b8EbTJnzapixZKvLB0" />
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-N10EQRCT7B"></script>
        <script
