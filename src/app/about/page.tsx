...
function page() {
  return (
    <div className=''>
      <Hero title={'About'} description={'Your trusted destination for premier hernia care in Austin and Surrounding Areas.'} />
      ...
      <div className="container md:max-w-[80%] mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[7rem] text-[13px]">
          ...
          <div className='grid md:grid-cols-2 items-center gap-[7rem] md:col-span-2'>
            <div>
              <h2 className="text-2xl font-bold mb-4 text-[#449DD1]">Termx and Conditions</h2>
              <p>
